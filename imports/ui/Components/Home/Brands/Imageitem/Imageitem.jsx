            ...
            <li className="ad-background" onClick={this.handleDeleteImage}>
                {
                    this.props.mediaFormat.split('/')[0] === 'image' ? (
                        <img onLoad={this.handleLoadingImage} className={setClass} src={`http://fia.unitec.edu/cfs/files/Images/${this.props.imagecode}?store=thumbs`} />
                    ) : (
                        <video id="myVideo" onLoadStart={this.handleLoadingImage} className={setClass}>
                            <source src={`http://fia.unitec.edu/cfs/files/Images/${this.props.imagecode}?store=container#t=5,10`} type={this.props.mediaFormat}/>
                        </video>
                    )
                }
